...
public class Controller01 {
    ...
    public void method2(WebRequest request, HttpServletResponse response) throws IOException {
    ...
    public void method3(WebRequest request, HttpServletResponse response) throws IOException {
